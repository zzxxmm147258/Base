...
public class WXBizMsgCrypt {
	...
	public String EncryptMsg(String replyMsg, String timeStamp, String nonce) throws AesException {
		return EncryptMsg(replyMsg, timeStamp, nonce, null);
	}
	
	public String EncryptMsg(String replyMsg, String timeStamp, String nonce, String keynum) throws AesException {
		// 加密
		...
		if (keynum == null)
			...
			result = XMLParse.generate2(encrypt, signature, timeStamp, nonce, keynum);
		return result;
	}
