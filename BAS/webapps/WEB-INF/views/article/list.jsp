...
<div class="container" style="width:100%;padding:0 15px;margin:0;"> 
	<form id="selectForm" action='<c:url value="/main/article/list"/>' method="post" >
    ...
    <div class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        ...
                        <table class="table-bordered table-condensed table-striped">
                           <thead>
                              <tr class='THD_width'>
                              	<th width="120">序号</th>
                              	<th width="100">操作
                              		<a href='<c:url value="/main/article/add"/>' style="padding:1px;height:24px;width:50px" type="button" class="btn btn-success" data-toggle="tooltip" data-placement="right" title="添加数据">添加</a>
                              	</th>
                              	<th width="200">标题</th>
					            <th width="200">作者</th>
                           ...
                           <c:forEach items="${list }" var="b" varStatus="i">
							<tr id="${b.id }">
								...
								<td class="text-center">
									<a  menuname="编辑" href='<c:url value="/main/article/edit?id=${b.id}"/>'><span class="glyphicon glyphicon-edit" style="font-size:16px" title="编辑"/></a>&nbsp&nbsp
								...
								<td style="text-align:center;">${b.articleCategory }</td>
								<td style="text-align:center;">
							      <c:choose>
						        ...
						        <td style="text-align: center;"> 
     								<img alt="" src="${b.url}"  style="width:30px;height:30px;">
     						    </td>
     						    <td style="text-align: center;"> 
     								<img alt="" src="${b.attr5}"  style="width:30px;height:30px;">
     						    </td>
     						    <td style="text-align:center;">
        ...
        <c:if test="${empty select}">
        	<div style="float:left"><portal:page url='<c:url value="/main/article/list"/>'/></div>
        </c:if>
</div>
</body>
<script type="text/javascript">
	...
	if(confirm("是否确定要删除？")){
		...
		$.ajax({
			url:'<c:url value="/main/article/del.ajax" />',
			data:{id:id},
			type:'post',
			success:function(data){
				if(data > 0){
