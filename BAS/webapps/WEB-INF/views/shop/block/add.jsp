...
<div class="modal" id="myModal" role="dialog" aria-labelledby="myModalLabel">
	<form:form  id="inputForm" method="${method }" modelAttribute="bean" enctype="multipart/form-data">
        ...
        <div class="panel-body">
			<div class="row">
			   <div class="col-md-4">
    				<label>街区号</label><form:errors path="blockNo" style="color:red;"/>
					 <form:input id="blockNo" path="blockNo" cssClass="form-control" /> 
    			</div>
    			
    			<div class="col-md-4">
    				<label>街区名称</label><form:errors path="blockName" style="color:red;"/>
					 <form:input id="blockName" path="blockName" cssClass="form-control" /> 
    			</div>
    			
			    <div class="col-sm-4">
    			<label>商圈</label><form:errors path="district" style="color:red;"/>
    			<form:select id="district" class="multiselect-search" path="district">
    		...
    		<div class="row">
				...
				<input type="submit" class="btn btn-primary"  onclick="return Info()" value="提交" /> <a
					href="<c:url value='/admin/block/list'/>" class="btn btn-success">返回</a>
		</div>   
		</div>  
		</div>
		</div>   
