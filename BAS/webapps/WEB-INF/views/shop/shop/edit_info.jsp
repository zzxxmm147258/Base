...
<script type="text/javascript">
	$().ready(function (){
		...
		var specificationValueIndex = '${fn:length(shopBas.shopbasinfo)}';
		// 修改规格类型
		...
		$addSpecificationValueButton.click(function() {
					...
					'<td><input type="text" name="shopbasinfo[' + specificationValueIndex + '].showPoint" class="form-control shopbasinfoshowPoint" maxlength="200" style="width: 50px;" oninput="checkInput(this)" \/><font color="red" style="display:none">必填</font><\/td>'+
					 '<td><select  name="shopbasinfo['+specificationValueIndex+'].showType" class="form-control" >'+
		                   ...
		                   '</select>'+
	                '</td>'+
					'<td><input type="text" name="shopbasinfo[' + specificationValueIndex + '].showTitle" class="form-control" maxlength="200" o \/><font color="red" style="display:none">必填</font><\/td>'+
					'<td><input type="file" name="shopbasinfo[' + specificationValueIndex + '].imgs" class="form-control" maxlength="200" \/><\/td>'+
					'<td><input type="text" name="shopbasinfo[' + specificationValueIndex + '].showExplain" class="form-control shopbasinfoshowExplain" data-toggle="modal"  data-target="#editModal" maxlength="250"  \/><\/td>'+
...
<div class="content scrollWH" scrollH='100'>
		 ...
		 <div class="form-group">
			...
			<div class="col-sm-2">
				<c:choose>
					...
					<c:otherwise>
						<input type="text" name="shopId" class="form-control" value="${shopBas.shopId}" readonly="true"/>
					</c:otherwise>
				</c:choose>
			</div>
			...
			<label for="firstname" class="col-sm-1 control-label">楼层</label>
				 ...
				 <c:choose>
			        <c:when test="${empty shopBas.floorId}">
						<input  type="hidden" id="floorId" name="floorId" class="form-control"   readonly="true"/>
					</c:when>
					<c:otherwise>
						<input type="hidden" id="floorId" name="floorId" class="form-control" value="${shopBas.floorId}" readonly="true"/>
					</c:otherwise>
				</c:choose>
				 <!-- <input  type="hidden" id="floorId" name="floorId" class="form-control"   readonly="true"/> -->
		...
		<table class="table" id="specificationTable">
			...
			<c:forEach  items="${shopBas.shopbasinfo}"  var="s" varStatus="abc">
				<tr class="specificationValueTr">
				<td>
				    <input type="text" name="shopbasinfo[${abc.index}].showPoint" class="form-control shopbasinfoshowPoint" style="width: 50px;" maxlength="200" oninput="checkInput(this)" value="${s.showPoint}"/>
				    <font color="red" style="display:none">必填</font>				
				</td>
				<td>
...
<%-- 					<input type="text" name="shopbasinfo[${abc.index}].showImage" class="text shopbasinfoshowImage" maxlength="200" disabled="disabled" value="${s.showImage}"/>					
 --%>					
                        <%-- <img alt="" src="${s.showImage}"  style="width:30px;height:30px;"> --%>
                        <input type="file" name="shopbasinfo[${abc.index}].imgs" class="form-control"  maxlength="200"  />
				</td>
				<td>			
					<input type="text" name="shopbasinfo[${abc.index}].showExplain" class="form-control shopbasinfoshowExplain" data-toggle="modal"  data-target="#editModal"  maxlength="250"  value="${s.showExplain}"/>				
				</td>
				<td>			
