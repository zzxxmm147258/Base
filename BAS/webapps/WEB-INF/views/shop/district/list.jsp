...
<div class="container" style="width:100%;padding:0 15px;margin:0;"> 
	<form id="selectForm" action='<c:url value="/admin/district/list"/>' method="post" >
        <div class="row" style="margin-bottom:10px;">
            <label class="control-label col-sm-1 col_padding">商圈编码：</label>
            <div class="col-sm-3">
                <div class="input-group">
                    <input name="filter.[v_like_3_,].district" value="${selectMap.district}" type="text" class="form-control">
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <input name="filter.[v_like_3_,].disname" value="${selectMap.disname}" type="text" class="form-control">
                </div>
            </div>
            
             <label class="control-label col-sm-1 col_padding">城市：</label>
            <div class="col-sm-3">
                <div class="input-group">
                    <input name="filter.[v_like_3_,].city" value="${selectMap.city}" type="text" class="form-control">
                </div>
            </div>
                        ...
                        <table class="table-bordered table-condensed table-striped">
                           <thead>
                              <tr class='THD_width'>
                              	<th width="120">序号</th>
                              	<th width="200">操作
                              		<a href='<c:url value="/admin/district/add"/>' style="padding:1px;height:24px;width:50px" type="button" class="btn btn-success" data-toggle="tooltip" data-placement="right" title="添加数据">添加</a>
                              	</th>
                              	<th width="200">商圈编码</th>
                           ...
                           <c:forEach items="${list }" var="b" varStatus="i">
							<tr district="${b.district }">
								<td style="text-align:center;">${i.count }</td>
								<td class="text-center">
									<a  menuname="修改" href='<c:url value="/admin/district/${b.district}/update"/>'><span class="glyphicon glyphicon-edit" style="font-size:16px" title="编辑"/></a>&nbsp&nbsp
								...
								<td style="text-align:center;">${b.disname }</td>
								<td style="text-align:center;">${b.city }</td>
								<td style="text-align: center;"> 
     								<img alt="" src="${b.districtLogo}"  style="width:30px;height:30px;">
     							</td>
     							<td style="text-align: center;"> 
...
<script type="text/javascript">
	...
	if(confirm("是否确定要删除？")){
		...
		var district = tr.getAttribute("district");
		$.ajax({
			url:'<c:url value="/admin/district/del.ajax" />',
